...
# --------------------
class InferYoloV11SegParam(core.CWorkflowTaskParam):
...
# --------------------
class InferYoloV11Seg(dataprocess.CInstanceSegmentationTask):
    ...
    def __init__(self, name, param):
        ...
        if param is None:
            self.set_param_object(InferYoloV11SegParam())
        else:
...
# --------------------
class InferYoloV11SegFactory(dataprocess.CTaskFactory):

    def __init__(self):
        dataprocess.CTaskFactory.__init__(self)
        # Set algorithm information/metadata here
        self.info.name = "infer_yolo_v11_seg"
        ...
        self.info.repository = "https://github.com/Ikomia-hub/infer_yolo_v11_seg"
    ...
    def create(self, param=None):
        ...
        return InferYoloV11Seg(self.info.name, param)
